...
?>
        <form action="setDocumentOffice" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
            <div class="modal-header">
                <h4><i class="bx bx-data"></i> Hapus Data Peserta Kegiatan Kantor</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="delAllParticipantOffice" class="btn btn-info" id="hapusSemuaPeserta" disabled>Hapus</button>
