...
?>
        <form action="setDocumentOffice" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
            <div class="modal-header">
                <h5><i class="bx bx-data"></i> Import Data Peserta kantor</h5>
            </div>
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <ul>
                        <li>Unduh format berikut : <a class="fw-bold" href="format/template_import_peserta_perjadin_kantor.xlsx">Download Format</a></li>
                        <li>Sheet <strong>import_sinatalie</strong> di isi sesuai dengan ekspor excel dari <strong>Aplikasi Registrasi</strong></li>
                        <li>Kolom yang diperlukan dari <strong>Aplikasi Registrasi</strong> yaitu<strong> nama, nip, gol, pangkat, jabatan, unit_kerja, alamat_unit_kerja, no_hp</strong></li>
                        <li>Format penulisan pada kolom NIP tidak diperkenankan ada spasi, titik atau petik</li>
                        ...
                        <li>Kolom <strong>jenis_peserta</strong> diisi <strong>internal</strong> jika dari BBPMP Provinsi Jawa Timur</li>
                        <li>Kolom <strong>jenis_peserta</strong> diisi <strong>eksternal</strong> jika dari luar BBPMP Provinsi Jawa Timur</li>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="uploadParticipantOffice" class="btn btn-info" id="importPeserta" disabled>Upload</button>
