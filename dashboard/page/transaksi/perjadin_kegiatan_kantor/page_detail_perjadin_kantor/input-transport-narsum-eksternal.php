...
if (isset($_POST['id']) && isset($_POST['token'])) {
    ...
    where tb_narsum_keg_kantor.id_keg = '$id_keg' and tb_narsum_keg_kantor.id_narsum_keg_kantor = '$id_narsum_keg_kantor' and tb_narsum_keg_kantor.jenis_narsum = 'eksternal'");
...
?>
        <form action="setDocumentOffice" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" oninput="seprator(this)" class="form-control border border-secondary" placeholder="ex. 1" name="jml_jam" id="jml_jam" value="<?= $viewNarsum['jml_jam'] ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" oninput="seprator(this)" class="form-control border border-secondary" placeholder="ex. 410000" name="tiket_pesawat" id="tiket_pesawat" value="<?= $viewNarsum['tiket_pesawat'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Tiket Kapal</label>
                            <input type="text" oninput="seprator(this)" class="form-control border border-secondary" placeholder="ex. 410000" name="tiket_kapal" id="tiket_kapal" value="<?= $viewNarsum['tiket_kapal'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Tiket</label>
                            <input type="text" oninput="seprator(this)" class="form-control border border-secondary" placeholder="ex. 410000" name="tiket" id="tiket" value="<?= $viewNarsum['tiket'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Transport Lokal</label>
                            <input type="text" oninput="seprator(this)" class="form-control border border-secondary" placeholder="ex. 410000" name="lokal" id="lokal" value="<?= $viewNarsum['lokal'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Transport Lokal Jakarta</label>
                            <input type="text" oninput="seprator(this)" class="form-control border border-secondary" placeholder="ex. 410000" name="lokal_jakarta" id="lokal_jakarta" value="<?= $viewNarsum['lokal_jakarta'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Taksi/Grab/Gojek</label>
                            <input type="text" oninput="seprator(this)" class="form-control border border-secondary" placeholder="ex. 410000" name="taksi" id="taksi" value="<?= $viewNarsum['taksi'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Toll</label>
                            <input type="text" oninput="seprator(this)" class="form-control border border-secondary" placeholder="ex. 410000" name="toll" id="toll" value="<?= $viewNarsum['toll'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">BBM</label>
                            <input type="text" oninput="seprator(this)" class="form-control border border-secondary" placeholder="ex. 410000" name="bbm" id="bbm" value="<?= $viewNarsum['bbm'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">DPR</label>
                            <input type="text" oninput="seprator(this)" class="form-control border border-secondary" placeholder="ex. 410000" name="dpr1" id="dpr1" value="<?= $viewNarsum['dpr1'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Penginapan</label>
                            <input type="text" oninput="seprator(this)" class="form-control border border-secondary" placeholder="ex. 410000" name="penginapan" id="penginapan" value="<?= $viewNarsum['penginapan'] ?>">
                        </div>
                    </div>
                </div>
                <?php
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="inputTransportInformantOffice" class="btn btn-info" id="inputTransportNarsum" disabled>Simpan</button>
