...
if (isset($_POST['id']) && isset($_POST['token'])) {
    ...
    $sqlPeserta = mysqli_query($myConnection, "select tb_panitia_keg_kantor.*, tb_kabkota.name as nama_kab
...
?>
        <form action="setDocumentOffice" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="delCommitteeOffice" class="btn btn-info" id="delPanitia" disabled>Hapus</button>
