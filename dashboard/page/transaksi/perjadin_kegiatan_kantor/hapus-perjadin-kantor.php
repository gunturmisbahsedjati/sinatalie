    ...
    if (mysqli_num_rows($sql) > 0) {
        ...
        <form action="setDocumentOffice" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
            <div class="modal-header">
                <h4><i class="bx bx-folder-plus"></i> Hapus Dokumen SPJ Kantor</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="delDocumentOffice" class="btn btn-info" id="delAkun" disabled>Hapus</button>
