...
if (isset($_POST['id']) && isset($_POST['token'])) {
    ...
    where tb_narsum_keg_hotel.id_keg = '$id_keg' and tb_narsum_keg_hotel.id_narsum_keg_hotel = '$id_narsum_keg_hotel'");
    if (mysqli_num_rows($sqlNarsum) > 0) {
        $viewNarsum = mysqli_fetch_array($sqlNarsum);
        $id_kabkota_unit_kerja = $viewNarsum['id_kabkota_unit_kerja'];
        $id_pangkat_gol = $viewNarsum['id_pangkat_gol'];
        $checkInternal = $viewNarsum['status_internal_kemdikbud'] == 1 ? 'checked' : '';
?>
        <form action="setDocumentHotel" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border border-secondary" value="<?= $viewNarsum['nama'] ?>" placeholder="Nama Lengkap Narasumber" name="nama" id="nama">
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">NIP</label>
                            <input type="text" class="form-control border border-secondary" value="<?= $viewNarsum['nip'] ?>" placeholder="NIP Narasumber" name="nip" id="nip">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border border-secondary" value="<?= $viewNarsum['no_hp'] ?>" placeholder="No. HP" name="no_hp" id="no_hp">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Jabatan</label>
                            <input type="text" class="form-control border border-secondary" value="<?= $viewNarsum['jabatan'] ?>" placeholder="Jabatan di Unit Kerja" name="jabatan" id="jabatan">
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                    <label class="form-label">Unit Kerja</label>
                    <input type="text" class="form-control border border-secondary" value="<?= $viewNarsum['unit_kerja'] ?>" placeholder="Unit Kerja Narasumber" name="unit_kerja" id="unit_kerja">
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Alamat Unit Kerja</label>
                            <textarea rows="3" class="form-control border border-secondary" placeholder="Alamat Lengkap Unit Kerja" name="alamat_unit_kerja"><?= $viewNarsum['alamat_unit_kerja'] ?></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="pt-2">
                    <div class="form-check">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="form-check-input" id="cek_internal" name="cek_internal" <?= $checkInternal ?>>
                ...
                <div class="pt-2">
                    <div class="form-check">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="form-check-input" id="edit_narsum" name="cek">
                            <label class="form-check-label" for="edit_narsum">Saya yakin mengubah Data Narasumber.</label>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" name="editInformantExternal" class="btn btn-info" id="editNarsum" disabled>Ubah</button>
        ...
        <script type="text/javascript">
            ...
            $('#edit_narsum').click(function() {
                if ($(this).is(':checked')) {

                    $('#editNarsum').removeAttr('disabled');

                } else {
                    $('#editNarsum').attr('disabled', true);
                }
            });
        </script>
<?php
