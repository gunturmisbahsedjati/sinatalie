...
?>
        ...
        <div class="modal-header">
            <h4 class="modal-title" id="modalFullTitle">Input Data Semua Transport Peserta</h4>
        ...
        <div class="modal-body">
            ...
            <div class="table-responsive">
                <table id="tabel_transport_semua_peserta" class="table table table-bordered table-hover" width=100% cellspacing="0">
                    ...
                    where tb_peserta_keg_hotel.id_keg = '$id_keg' limit 10");
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="inputTransportParticipant" class="btn btn-info" id="inputTranspor" disabled>Upload</button>
