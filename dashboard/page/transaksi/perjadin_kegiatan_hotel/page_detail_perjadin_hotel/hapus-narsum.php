...
if (isset($_POST['id']) && isset($_POST['token'])) {
    ...
    $sqlPeserta = mysqli_query($myConnection, "select tb_narsum_keg_hotel.*, tb_kabkota.name as nama_kab
...
?>
        <form action="setDocumentHotel" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="delInformant" class="btn btn-info" id="delNarsum" disabled>Hapus</button>
