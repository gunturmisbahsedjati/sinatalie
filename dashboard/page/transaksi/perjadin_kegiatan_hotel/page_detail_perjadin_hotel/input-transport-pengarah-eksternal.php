...
if (isset($_POST['id']) && isset($_POST['token'])) {
    ...
    $id_pengarah_keg_hotel = decrypt($_POST['id']);
    ...
    where tb_pengarah_keg_hotel.id_keg = '$id_keg' and tb_pengarah_keg_hotel.id_pengarah_keg_hotel = '$id_pengarah_keg_hotel' and tb_pengarah_keg_hotel.jenis_pengarah = 'eksternal'");
    if (mysqli_num_rows($sqlPengarah) > 0) {
        ...
        $viewPengarah['bbm'] = $viewPengarah['bbm'] == '' ? '' : number_format($viewPengarah['bbm'], 0);
        $viewPengarah['tiket_pesawat'] = $viewPengarah['tiket_pesawat'] == '' ? '' :  number_format($viewPengarah['tiket_pesawat'], 0);
        $viewPengarah['tiket'] = $viewPengarah['tiket'] == '' ? '' :  number_format($viewPengarah['tiket'], 0);
        $viewPengarah['tiket_kapal'] = $viewPengarah['tiket_kapal'] == '' ? '' :  number_format($viewPengarah['tiket_kapal'], 0);
        $viewPengarah['lokal'] = $viewPengarah['lokal'] == '' ? '' :   number_format($viewPengarah['lokal'], 0);
        $viewPengarah['taksi'] = $viewPengarah['taksi'] == '' ? '' :  number_format($viewPengarah['taksi'], 0);
        $viewPengarah['toll'] = $viewPengarah['toll'] == '' ? '' :  number_format($viewPengarah['toll'], 0);
        $viewPengarah['dpr1'] = $viewPengarah['dpr1'] == '' ? '' :  number_format($viewPengarah['dpr1'], 0);
?>
        <form action="setDocumentHotel" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" oninput="seprator(this)" step="any" class="form-control border border-secondary" placeholder="ex. 410000" name="tiket_pesawat" id="tiket_pesawat" value="<?= $viewPengarah['tiket_pesawat'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Tiket Kapal</label>
                            <input type="text" oninput="seprator(this)" step="any" class="form-control border border-secondary" placeholder="ex. 410000" name="tiket_kapal" id="tiket_kapal" value="<?= $viewPengarah['tiket_kapal'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Tiket</label>
                            <input type="text" oninput="seprator(this)" step="any" class="form-control border border-secondary" placeholder="ex. 410000" name="tiket" id="tiket" value="<?= $viewPengarah['tiket'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Transport Lokal</label>
                            <input type="text" oninput="seprator(this)" step="any" class="form-control border border-secondary" placeholder="ex. 410000" name="lokal" id="lokal" value="<?= $viewPengarah['lokal'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Taksi/Grab/Gojek</label>
                            <input type="text" oninput="seprator(this)" step="any" class="form-control border border-secondary" placeholder="ex. 410000" name="taksi" id="taksi" value="<?= $viewPengarah['taksi'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Toll</label>
                            <input type="text" oninput="seprator(this)" step="any" class="form-control border border-secondary" placeholder="ex. 410000" name="toll" id="toll" value="<?= $viewPengarah['toll'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">BBM</label>
                            <input type="text" oninput="seprator(this)" step="any" class="form-control border border-secondary" placeholder="ex. 410000" name="bbm" id="bbm" value="<?= $viewPengarah['bbm'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">DPR 1</label>
                            <input type="text" oninput="seprator(this)" step="any" class="form-control border border-secondary" placeholder="ex. 410000" name="dpr1" id="dpr1" value="<?= $viewPengarah['dpr1'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">DPR 2</label>
                            <input type="text" oninput="seprator(this)" step="any" class="form-control border border-secondary" placeholder="ex. 410000" name="dpr2" id="dpr2" value="<?= $viewPengarah['dpr2'] ?>">
                        </div>
                    </div>
                </div>
                <?php
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" value="<?= encrypt($id_pengarah_keg_hotel) ?>" name="_id">
                <button type="submit" name="inputDirectorInformant" class="btn btn-info" id="inputTransportPengarah" disabled>Simpan</button>
