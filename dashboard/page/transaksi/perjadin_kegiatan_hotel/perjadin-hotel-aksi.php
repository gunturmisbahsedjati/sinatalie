...
if (in_array(1, $arrayAkses)) {
    if (isset($_GET['insertDocumentHotel'])) {
        $code2 = time() . '-' . uniqid();
        ...
        if ($getDataSTPerjadinByIDView['status']['code'] == '200') {
            ...
            if ($getDataPegSTPerjadinView['status']['code'] == '200') {
                ...
                $sqlInsertPeg = "insert into tb_panitia_keg_hotel (id_panitia_keg_hotel, id_keg, id_peg_st_siratu, id_st_siratu, id_peg, id_jab_st, nama, nip, gol, pangkat, id_pangkat_gol, jabatan, unit_kerja, alamat_unit_kerja, kabkota_unit_kerja, id_kabkota_unit_kerja, no_hp, tgl_mulai, tgl_selesai, lokal, jenis_panitia, created_by) values";
            ...
            echo '<script> window.location="documentHotel?_token=' . encrypt($thn_st) . '"; </script>';
        } else {
            $_SESSION['alert'] = "Toast.fire({icon: 'error',title: 'SQL Injection terdeteksi'})";
            echo '<script> window.location="documentHotel?_token=' . encrypt($thn_st) . '"; </script>';
        }
    } elseif (isset($_POST['delDocumentHotel'])) {
        $created_by = $_SESSION['id'];
        ...
        $delPanitia = mysqli_query($myConnection, "delete from tb_panitia_keg_hotel where id_keg = '$id_keg'");
        $delPeserta = mysqli_query($myConnection, "delete from tb_peserta_keg_hotel where id_keg = '$id_keg'");
        $delPengarah = mysqli_query($myConnection, "delete from tb_pengarah_keg_hotel where id_keg = '$id_keg'");
    ...
    } elseif (isset($_POST['documentHotelStatus'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
    ...
    } elseif (isset($_POST['uploadParticipant'])) {
        $created_by = $_SESSION['id'];
        $now = date("dmYHis");
        ...
        if (in_array('import_sinatalie', $arraySheet)) {
            ...
            if ($insertPesertaHotel) {
                ...
                echo '<script> window.location="checkDocumentHotel?_token=' . encrypt($id_keg) . '&_type=peserta"; </script>';
            } else {
    ...
    } elseif (isset($_POST['delAllParticipant'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
    ...
    } elseif (isset($_POST['inputTransportParticipant'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        $id_peserta_keg_hotel = mysqli_escape_string($myConnection, decrypt($_POST['_id']));

        $cekPeserta = mysqli_query($myConnection, "select * from tb_peserta_keg_hotel where id_keg = '$id_keg' and id_peserta_keg_hotel = '$id_peserta_keg_hotel'");
        if (mysqli_num_rows($cekPeserta) > 0) {
            ...
            $input = mysqli_query($myConnection, "update tb_peserta_keg_hotel set
            tgl_mulai = '$tgl_mulai',
            ...
            where id_peserta_keg_hotel = '$id_peserta_keg_hotel' and id_keg = '$id_keg' ");
            if ($input) {
    ...
    } elseif (isset($_POST['delParticipant'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        $id_peserta_keg_hotel = mysqli_escape_string($myConnection, decrypt($_POST['_id']));
        ...
        if (mysqli_num_rows($cekPeserta) > 0) {
            ...
            $input = mysqli_query($myConnection, "delete from tb_peserta_keg_hotel where id_peserta_keg_hotel = '$id_peserta_keg_hotel' and id_keg = '$id_keg' ");
            if ($input) {
    ...
    } elseif (isset($_POST['saveTransportParticipant'])) {
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['saveTransportParticipant']));
        // echo $id_keg;
        if (isset($_POST['_id'])) {
            $bbm1 = $_POST['bbm'];
            $tiket1 = $_POST['tiket'];
            ...
            $dpr11 = $_POST['dpr1'];
            // $dpr21 = $_POST['dpr2'];
            $id_peserta_keg_hotel1 = $_POST['_id'];
            $tgl_mulai1 = $_POST['tgl_mulai'];
            $tgl_selesai1 = $_POST['tgl_selesai'];
            $totalPeserta = count($id_peserta_keg_hotel1);
            for ($i = 0; $i < $totalPeserta; $i++) {
                $id_peserta_keg_hotel = mysqli_escape_string($myConnection, decrypt($id_peserta_keg_hotel1[$i]));
    ...
    } elseif (isset($_POST['settingReceiptHotel'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        ...
        if ($updateKuitansi) {
            ...
            echo '<script> window.location="checkDocumentHotel?_token=' . encrypt($id_keg) . '&_type=' . $page . '"; </script>';
        } else {
            $_SESSION['alert'] = "Toast.fire({icon: 'error',title: 'Pengaturan gagal disimpan'})";
            echo '<script> window.location="checkDocumentHotel?_token=' . encrypt($id_keg) . '&_type=' . $page . '"; </script>';
        }
    } elseif (isset($_POST['settingFinancialReceiptHotel'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
    ...
    } elseif (isset($_POST['addFinancialOfficer'])) {
        $created_by = $_SESSION['id'];
        $id_keg =  mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        ...
        if (mysqli_num_rows($cekKegiatan) > 0) {
            ...
            $id_panitia_keg_hotel = mysqli_escape_string($myConnection, $_POST['petugas_keu']);
            $page = mysqli_escape_string($myConnection, decrypt($_POST['_type']));
            // echo $id_panitia_keg_hotel;
            $sqlPeg = mysqli_query($myConnection, "select * from tb_panitia_keg_hotel where id_panitia_keg_hotel = '$id_panitia_keg_hotel'");
            if (mysqli_num_rows($sqlPeg) > 0) {
                $viewPetugas = mysqli_fetch_array($sqlPeg);
                $id_peg = $viewPetugas['id_peg'];
                $sqlInputPetugas = mysqli_query($myConnection, "insert into tb_petugas_keuangan_keg_hotel (id_petugas_keu_keg, id_keg, id_panitia_keg_hotel) values ('$id_panitia_keg_hotel', '$id_keg', '$id_panitia_keg_hotel')");
                if ($sqlInputPetugas) {
    ...
    } elseif (isset($_POST['delFinancialOfficer'])) {
        $created_by = $_SESSION['id'];
        $id_keg =  mysqli_escape_string($myConnection, decrypt($_POST['_key']));
    ...
    } elseif (isset($_POST['addExternalDirector'])) {
        $created_by = $_SESSION['id'];
        $code2 = time() . '-' . uniqid();
        $code = strtoupper($code2);
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
    ...
    } elseif (isset($_POST['addInternalDirector'])) {
        $created_by = $_SESSION['id'];
        $code2 = time() . '-' . uniqid();
        $code = strtoupper($code2);
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
    ...
    } elseif (isset($_POST['editDirectorExternal'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        $id_pengarah_keg_hotel = mysqli_escape_string($myConnection, decrypt($_POST['_id']));

        $cekPengarah = mysqli_query($myConnection, "select * from tb_pengarah_keg_hotel where id_keg = '$id_keg' and id_pengarah_keg_hotel = '$id_pengarah_keg_hotel'");
        if (mysqli_num_rows($cekPengarah) > 0) {
            ...
            $update = mysqli_query($myConnection, "update tb_pengarah_keg_hotel set
            nama = '$nama',
            nip = '$nip',
            gol = '$gol',
            pangkat = '$pangkat',
            ...
            no_hp = '$no_hp'
            where id_keg = '$id_keg' and id_pengarah_keg_hotel = '$id_pengarah_keg_hotel' ");
            if ($update) {
    ...
    } elseif (isset($_POST['delDirector'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        $id_pengarah_keg_hotel = mysqli_escape_string($myConnection, decrypt($_POST['_id']));
        ...
        if (mysqli_num_rows($cekPengarah) > 0) {
            ...
            $input = mysqli_query($myConnection, "delete from tb_pengarah_keg_hotel where id_pengarah_keg_hotel = '$id_pengarah_keg_hotel' and id_keg = '$id_keg' ");
            if ($input) {
    ...
    } elseif (isset($_POST['addInternalInformant'])) {
        $created_by = $_SESSION['id'];
        $code2 = time() . '-' . uniqid();
        $code = strtoupper($code2);
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        ...
        if (mysqli_num_rows($cekKegiatan) > 0) {
            ...
            if (mysqli_num_rows($sqlCekPeg) > 0) {
                ...
                $sql = "insert into tb_narsum_keg_hotel (id_narsum_keg_hotel, id_keg, id_peg, nama, nip, gol, pangkat, id_pangkat_gol, jabatan, unit_kerja, alamat_unit_kerja, kabkota_unit_kerja, id_kabkota_unit_kerja, no_hp, tgl_mulai, tgl_selesai, jenis_narsum, lokal, created_by,created_date) values ('$code', '$id_keg', '$id_peg', '$nama', '$nip', '$gol', '$pangkat', '$id_pangkat', '$jabatan', '$unit_kerja', '$alamat_unit_kerja', '$kabkota_unit_kerja', '$id_kabkota', '$no_hp', '$tgl_mulai', '$tgl_selesai', 'internal', '$sbmSurabaya', '$created_by', NOW())";
                // echo $sql;
                $input = mysqli_query($myConnection, $sql);
                if ($input) {
                    $_SESSION['alert'] = "Toast.fire({icon: 'success',title: 'Narasumber berhasil ditambahkan'})";
                    echo '<script> window.location="checkDocumentHotel?_token=' . encrypt($id_keg) . '&_type=narsum"; </script>';
                } else {
    ...
    } elseif (isset($_POST['addExternalInformant'])) {
        $created_by = $_SESSION['id'];
        $code2 = time() . '-' . uniqid();
        $code = strtoupper($code2);
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
    ...
    } elseif (isset($_POST['delInformant'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        $id_narsum_keg_hotel = mysqli_escape_string($myConnection, decrypt($_POST['_id']));

        $cekPengarah = mysqli_query($myConnection, "select * from tb_narsum_keg_hotel where id_keg = '$id_keg' and id_narsum_keg_hotel = '$id_narsum_keg_hotel'");
        if (mysqli_num_rows($cekPengarah) > 0) {

            $input = mysqli_query($myConnection, "delete from tb_narsum_keg_hotel where id_narsum_keg_hotel = '$id_narsum_keg_hotel' and id_keg = '$id_keg' ");
            if ($input) {
    ...
    } elseif (isset($_POST['editInformantExternal'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        $id_narsum_keg_hotel = mysqli_escape_string($myConnection, decrypt($_POST['_id']));
        ...
        if (mysqli_num_rows($cekPengarah) > 0) {
            ...
            $update = mysqli_query($myConnection, "update tb_narsum_keg_hotel set
            nama = '$nama',
            nip = '$nip',
            gol = '$gol',
            pangkat = '$pangkat',
            ...
            where id_keg = '$id_keg' and id_narsum_keg_hotel = '$id_narsum_keg_hotel' ");
            if ($update) {
    ...
    } elseif (isset($_POST['inputTransportInformant'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        $id_narsum_keg_hotel = mysqli_escape_string($myConnection, decrypt($_POST['_id']));

        $cekNarsum = mysqli_query($myConnection, "select * from tb_narsum_keg_hotel where id_keg = '$id_keg' and id_narsum_keg_hotel = '$id_narsum_keg_hotel' and jenis_narsum = 'eksternal'");
        if (mysqli_num_rows($cekNarsum) > 0) {
            ...
            $input = mysqli_query($myConnection, "update tb_narsum_keg_hotel set
            tgl_mulai = '$tgl_mulai',
            tgl_selesai = '$tgl_selesai',
            jml_jam = '$jml_jam',
            bbm = '$bbm',
            ...
            status_kabkota_unit_kerja = '$status_kabkota_unit_kerja'
            where id_narsum_keg_hotel = '$id_narsum_keg_hotel' and id_keg = '$id_keg' ");
            if ($input) {
                $_SESSION['alert'] = "Toast.fire({icon: 'success',title: 'Transport berhasil disimpan'})";
                echo '<script> window.location="checkDocumentHotel?_token=' . encrypt($id_keg) . '&_type=narsum"; </script>';
            } else {
    ...
    } elseif (isset($_POST['inputDirectorInformant'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        $id_pengarah_keg_hotel = mysqli_escape_string($myConnection, decrypt($_POST['_id']));

        $cekPengarah = mysqli_query($myConnection, "select * from tb_pengarah_keg_hotel where id_keg = '$id_keg' and id_pengarah_keg_hotel = '$id_pengarah_keg_hotel' and jenis_pengarah = 'eksternal'");
        if (mysqli_num_rows($cekPengarah) > 0) {
            $jml_jam = mysqli_escape_string($myConnection, bersihkan($_POST['jml_jam']));
            $bbm = mysqli_escape_string($myConnection, bersihkan($_POST['bbm']));
            $tiket_pesawat = mysqli_escape_string($myConnection, bersihkan($_POST['tiket_pesawat']));
            ...
            $input = mysqli_query($myConnection, "update tb_pengarah_keg_hotel set
            tgl_mulai = '$tgl_mulai',
            tgl_selesai = '$tgl_selesai',
            jml_jam = '$jml_jam',
            bbm = '$bbm',
            ...
            dpr2 = '$dpr2',
            status_kabkota_unit_kerja = '$status_kabkota_unit_kerja'
            where id_pengarah_keg_hotel = '$id_pengarah_keg_hotel' and id_keg = '$id_keg' ");
            if ($input) {
                $_SESSION['alert'] = "Toast.fire({icon: 'success',title: 'Transport berhasil disimpan'})";
                echo '<script> window.location="checkDocumentHotel?_token=' . encrypt($id_keg) . '&_type=pengarah"; </script>';
            } else {
    ...
    } elseif (isset($_POST['addInternalCommittee'])) {
        $created_by = $_SESSION['id'];
        $code2 = time() . '-' . uniqid();
        $code = strtoupper($code2);
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        ...
        if (mysqli_num_rows($cekKegiatan) > 0) {
            ...
            if (mysqli_num_rows($sqlCekPeg) > 0) {
                ...
                $sql = "insert into tb_panitia_keg_hotel (id_panitia_keg_hotel, id_keg, id_peg, id_jab_st, nama, nip, gol, pangkat, id_pangkat_gol, jabatan, unit_kerja, alamat_unit_kerja, kabkota_unit_kerja, id_kabkota_unit_kerja, no_hp, tgl_mulai, tgl_selesai, jenis_panitia, lokal, created_by,created_date) values ('$code', '$id_keg', '$id_peg', '$id_jab_st', '$nama', '$nip', '$gol', '$pangkat', '$id_pangkat', '$jabatan', '$unit_kerja', '$alamat_unit_kerja', '$kabkota_unit_kerja', '$id_kabkota', '$no_hp', '$tgl_mulai', '$tgl_selesai', 'internal', '$sbmSurabaya', '$created_by', NOW())";
                // echo $sql;
                $input = mysqli_query($myConnection, $sql);
                if ($input) {
                    $_SESSION['alert'] = "Toast.fire({icon: 'success',title: 'Panitia berhasil ditambahkan'})";
                    echo '<script> window.location="checkDocumentHotel?_token=' . encrypt($id_keg) . '&_type=panitia"; </script>';
                } else {
    ...
    } elseif (isset($_POST['delCommittee'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        $id_panitia_keg_hotel = mysqli_escape_string($myConnection, decrypt($_POST['_id']));

        $cekPanitia = mysqli_query($myConnection, "select * from tb_panitia_keg_hotel where id_keg = '$id_keg' and id_panitia_keg_hotel = '$id_panitia_keg_hotel'");
        if (mysqli_num_rows($cekPanitia) > 0) {

            $input = mysqli_query($myConnection, "delete from tb_panitia_keg_hotel where id_panitia_keg_hotel = '$id_panitia_keg_hotel' and id_keg = '$id_keg' ");
            if ($input) {
    ...
    } elseif (isset($_POST['addExternalCommittee'])) {
        $created_by = $_SESSION['id'];
        $code2 = time() . '-' . uniqid();
        $code = strtoupper($code2);
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        ...
        if (mysqli_num_rows($cekPanitia) > 0) {
            ...
            $update = mysqli_query($myConnection, "update tb_panitia_keg_hotel set
            id_jab_st = '$id_jab_st',
            nama = '$nama',
            nip = '$nip',
            gol = '$gol',
            ...
            id_kabkota_unit_kerja = '$id_kabkota',
            no_hp = '$no_hp'
            where id_keg = '$id_keg' and id_panitia_keg_hotel = '$id_panitia_keg_hotel' ");
            if ($update) {
    ...
    } elseif (isset($_POST['editAttendanceCommittee'])) {
        $created_by = $_SESSION['id'];
        $id_keg = mysqli_escape_string($myConnection, decrypt($_POST['_token']));
        $id_panitia_keg_hotel = mysqli_escape_string($myConnection, decrypt($_POST['_id']));
