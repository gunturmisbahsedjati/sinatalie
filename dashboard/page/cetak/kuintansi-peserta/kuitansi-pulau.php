...
$mpdf->WriteHTML('<tr>
                    ...
                    <td colspan="3" style="vertical-align:top;text-align: justify;text-justify: inter-word;">
                        <span style="font-weight:bold;">Biaya Perjalanan Dinas Peserta</span><br>
                       ...
                       <span style="font-weight:bold;">' . $viewPeserta['kabkota_unit_kerja'] . ' ( Kepulauan ) - ' . str_replace('Kabupaten', 'Kab.', ucwords($viewKeg['nama_kab'])) . ' PP</span>
                    </td>
                </tr>');
$mpdf->WriteHTML('</table><br>');
...
$mpdf->WriteHTML('<tr>
                ...
                <td width="23%"></td>
                <td width="7%"></td>
                <td width="30%">Tiket Kapal</td>
                <td width="3%"></td>
                <td width="2%">:</td>
                <td width="2%">Rp.</td>
                <td style="text-align:right" width="20%">' . format_angka($tiketKapal) . ',-</td>
                <td></td>
                </tr>
                <tr>
                <td width="23%"></td>
                ...
                <td width="23%"></td>
                <td width="7%"></td>
                <td width="30%">Uang Harian H - 1</td>
                <td width="3%"></td>
                <td width="2%">:</td>
                <td width="2%">Rp.</td>
                <td style="text-align:right" width="20%">' . format_angka($uangHarianPesertaHmin1) . ',-</td>
                <td></td>
                </tr>
                <tr>
                <td width="23%"></td>
                ...
                <td width="2%">:</td>
                <td width="2%">Rp.</td>
                <td style="text-align:right" width="20%">' . format_angka($uangHarianPesertaHplus1) . ',-</td>
                <td></td>
                </tr>
                ' . $kui_hotel . '
                <tr>
