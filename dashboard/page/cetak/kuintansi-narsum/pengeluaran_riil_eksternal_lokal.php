...
$mpdf->WriteHTML('<tr>
    ...
    <td style="padding-left:0.8em;">Transport ' . str_replace('Kabupaten', 'Kab.', ucwords($viewKeg['nama_kab'])) . ' - ' . $viewNarsum['kabkota_unit_kerja'] . ' PP</td>
    <td style="text-align: right;padding-right:0.8em;">Rp. ' . format_angka($transportNarsum) . ',-</td>
</tr>');
$mpdf->WriteHTML('<tr>
