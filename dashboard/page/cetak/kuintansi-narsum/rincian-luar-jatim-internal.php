...
$mpdf->WriteHTML('
                <tr>
                <td style="text-align:center;border-style:solid;border-width: 0px 1px 0px 1px" height="20px">1.</td>
                <td style="padding-left:0.8em;border-style:solid;border-width: 0px 1px 0px 0px">Transport Darat</td>
                <td style="border-style:solid;border-width: 0px 0px 0px 0px;padding-left:0.8em;">Rp</td>
                <td style="border-left:0px;text-align:right;padding-right:0.8em;border-style:solid;border-width: 0px 0px 0px 0px">' . format_angka($transportNarsum) . ',-</td>
                <td style="border-style:solid;border-width: 0px 1px 0px 1px"></td>
                </tr>
                <tr>
                <td style="text-align:center;border-style:solid;border-width: 0px 1px 0px 1px" height="20px">2.</td>
                <td style="padding-left:0.8em;border-style:solid;border-width: 0px 1px 0px 0px">Tiket Pesawat PP</td>
                <td style="border-style:solid;border-width: 0px 0px 0px 0px;padding-left:0.8em;">Rp</td>
                <td style="border-left:0px;text-align:right;padding-right:0.8em;border-style:solid;border-width: 0px 0px 0px 0px">' . format_angka($tiketPesawat) . ',-</td>
                <td style="border-style:solid;border-width: 0px 1px 0px 1px"></td>
                </tr>
                <tr>
                <td style="text-align:center;border-style:solid;border-width: 0px 1px 0px 1px" height="20px">3.</td>
                <td style="padding-left:0.8em;border-style:solid;border-width: 0px 1px 0px 0px">Uang Harian</td>
                <td style="border-style:solid;border-width: 0px 0px 0px 0px;padding-left:0.8em;">Rp</td>
                <td style="border-left:0px;text-align:right;padding-right:0.8em;border-style:solid;border-width: 0px 0px 0px 0px">' . format_angka($uangHarianNarsum) . ',-</td>
                <td style="border-style:solid;border-width: 0px 1px 0px 1px"></td>
                </tr>
                <tr>
                <td style="text-align:center;border-style:solid;border-width: 0px 1px 0px 1px" height="20px">4.</td>
                ...
                <tr>
                <td style="text-align:center;border-style:solid;border-width: 0px 1px 0px 1px" height="30px"></td>
                <td style="padding-left:0.8em;border-style:solid;border-width: 0px 1px 0px 0px"></td>
                <td style="border-style:solid;border-width: 0px 0px 0px 0px;padding-left:0.8em;"></td>
                <td style="border-left:0px;text-align:right;padding-right:0.8em;border-style:solid;border-width: 0px 0px 0px 0px"></td>
                <td style="border-style:solid;border-width: 0px 1px 0px 1px"></td>
                </tr>
                <tr>
                <td  height="40px"></td>
                ...
                <td style="border-left:0px;text-align:right;padding-right:0.8em;font-weight:bold">' . format_angka($jmlPerjadinNarsum) . ',-</td>
                <td></td>
                </tr>');
$mpdf->WriteHTML("</table><br>");
...
$mpdf->WriteHTML('<tr>
        <td width="50%"></td>
        <td>' . ucwords(str_replace(["kabupaten ", "kota "], ["kab. ", "kota "], $viewKeg['nama_kab'])) . ', ' . Indonesia2Tgl($viewNarsum['tgl_selesai']) . '</td>
    </tr>');
$mpdf->WriteHTML('<tr>
...
$mpdf->WriteHTML('<tr>
        <td>Rp. ' . format_angka($jmlPerjadinNarsum) . '.-</td>
        <td>Rp. ' . format_angka($jmlPerjadinNarsum) . '.-</td>
    </tr>');
$mpdf->WriteHTML('<tr>
...
$mpdf->WriteHTML('<tr>
        ...
        <td>' . $viewNarsum['nama'] . '</td>
    </tr>');
$mpdf->WriteHTML('<tr>
        <td style="border-style:solid;border-bottom:1px;">NIP. ' . $viewBendahara['nip'] . '</td>
        <td style="border-style:solid;border-bottom:1px;">NIP. ' . $viewNarsum['nip'] . '</td>
    </tr>');
$mpdf->WriteHTML("</table>");
...
$mpdf->WriteHTML('<tr>
        ...
        <td width="2%">:</td>
        <td width="2%">Rp. </td>
        <td width="15%" style="text-align:right;">' . format_angka($jmlPerjadinNarsum) . ',-</td>
        <td></td>
        <td></td>
    </tr>');
$mpdf->WriteHTML('<tr>
        ...
        <td width="15%" style="text-align:right;border-style:solid;border-bottom:1px">' . format_angka($jmlPerjadinNarsum) . ',-</td>
        <td></td>
        <td></td>
    </tr>');
$mpdf->WriteHTML('<tr>
