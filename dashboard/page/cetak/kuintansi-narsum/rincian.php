...
$mpdf->WriteHTML('<tr>
                <td style="text-align:center;border-style:solid;border-width: 0px 1px 0px 1px" height="40px">1.</td>
                ...
                <tr>
                <td style="text-align:center;border-style:solid;border-width: 0px 1px 0px 1px" height="40px"></td>
                ...
                <td style="border-left:0px;text-align:right;padding-right:0.8em;font-weight:bold">' . format_angka($transportNarsum) . ',-</td>
                <td></td>
                </tr>');
$mpdf->WriteHTML("</table><br>");
...
$mpdf->WriteHTML('<tr>
        <td>Rp. ' . format_angka($transportNarsum) . '.-</td>
        <td>Rp. ' . format_angka($transportNarsum) . '.-</td>
    </tr>');
$mpdf->WriteHTML('<tr>
...
$mpdf->WriteHTML('<tr>
        ...
        <td style="border-style:solid;border-bottom:1px;">' . $viewNarsum['nip'] . '</td>
    </tr>');
$mpdf->WriteHTML("</table>");
...
$mpdf->WriteHTML('<tr>
        ...
        <td width="15%" style="text-align:right;border-style:solid;border-bottom:1px">' . format_angka($transportNarsum) . ',-</td>
        <td></td>
        <td></td>
    </tr>');
$mpdf->WriteHTML('<tr>
