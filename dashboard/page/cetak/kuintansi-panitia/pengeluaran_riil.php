...
$mpdf->WriteHTML('<tr>
        ...
        <td colspan="14" style="padding-left:0.2em;border-style:solid;">' . $viewPanitia['nama'] . '</td>
    </tr>');
$mpdf->WriteHTML('<tr>
        <td style="" width="13%" height="25px">NIP</td>
        <td style="text-align: center;" width="2%">:</td>
        <td colspan="14" style="padding-left:0.2em;border-style:solid;">' . $viewPanitia['nip'] . '</td>
    </tr>');
$mpdf->WriteHTML('<tr>
        <td style="" width="13%" height="25px">Jabatan</td>
        <td style="text-align: center;" width="2%">:</td>
        <td colspan="14" style="padding-left:0.2em;border-style:solid;">' . $viewPanitia['jabatan'] . '</td>
    </tr>');
$mpdf->WriteHTML('<tr>
        <td style="" width="13%" height="25px">Instansi</td>
        <td style="text-align: center;" width="2%">:</td>
        <td colspan="14" style="padding-left:0.2em;border-style:solid;">' . $viewPanitia['unit_kerja'] . ', ' . $viewPanitia['kabkota_unit_kerja'] . '</td>
    </tr>');
$mpdf->WriteHTML('</table>');
...
$mpdf->WriteHTML('<tr>
        ...
        <td style="padding-left:0.8em;">Transport ' . str_replace('Kabupaten', 'Kab.', ucwords($viewKeg['nama_kab'])) . ' - ' . $viewPanitia['kabkota_unit_kerja'] . ' PP</td>
        <td style="text-align: right;padding-right:0.8em;">Rp. ' . format_angka($transportPanitia) . ',-</td>
    </tr>');
$mpdf->WriteHTML('<tr>
        <td style="text-align: center;" width="5%" height="25px"></td>
        <td style="text-align: center;font-weight:bold">Jumlah</td>
        <td style="text-align: right;padding-right:0.8em;font-weight:bold">Rp. ' . format_angka($transportPanitia) . ',-</td>
    </tr>');
