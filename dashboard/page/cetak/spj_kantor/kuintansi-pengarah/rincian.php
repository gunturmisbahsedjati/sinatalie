...
$mpdf->WriteHTML('<tr>
                ...
                <td style="border-left:0px;text-align:right;padding-right:0.8em;border-style:solid;border-width: 0px 0px 0px 0px">' . format_angka($transportPengarah) . ',-</td>
                ...
                <td style="border-left:0px;text-align:right;padding-right:0.8em;font-weight:bold">' . format_angka($transportPengarah) . ',-</td>
                <td></td>
                </tr>');
$mpdf->WriteHTML("</table><br>");
...
$mpdf->WriteHTML('<tr>
        <td width="50%"></td>
        <td>' . ucwords(str_replace(["kabupaten ", "kota "], ["kab. ", "kota "], $viewKeg['nama_kab'])) . ', ' . Indonesia2Tgl($viewPengarah['tgl_selesai']) . '</td>
    </tr>');
$mpdf->WriteHTML('<tr>
...
$mpdf->WriteHTML('<tr>
        <td>Rp. ' . format_angka($transportPengarah) . '.-</td>
        <td>Rp. ' . format_angka($transportPengarah) . '.-</td>
    </tr>');
$mpdf->WriteHTML('<tr>
...
$mpdf->WriteHTML('<tr>
        ...
        <td style="border-style:solid;border-bottom:1px;">NIP. ' . $viewPengarah['nip'] . '</td>
    </tr>');
$mpdf->WriteHTML("</table>");
...
$mpdf->WriteHTML('<tr>
        ...
        <td width="15%" style="text-align:right;border-style:solid;border-bottom:1px">' . format_angka($transportPengarah) . ',-</td>
        <td></td>
        <td></td>
    </tr>');
$mpdf->WriteHTML('<tr>
