...
$mpdf->WriteHTML('<tr>
    ...
    <td colspan = "14" style="padding-left:0.2em;border-style:solid;">' . $viewPengarah['nama'] . '</td>
    </tr>');
$mpdf->WriteHTML('<tr>
    <td style="" width="13%" height="25px">NIP</td>
    <td style="text-align: center;" width="2%">:</td>
    <td colspan = "14" style="padding-left:0.2em;border-style:solid;">' . $viewPengarah['nip'] . '</td>
    </tr>');
$mpdf->WriteHTML('<tr>
    <td style="" width="13%" height="25px">Jabatan</td>
    <td style="text-align: center;" width="2%">:</td>
    <td colspan = "14" style="padding-left:0.2em;border-style:solid;">' . $viewPengarah['jabatan'] . '</td>
    </tr>');
$mpdf->WriteHTML('<tr>
    <td style="" width="13%" height="25px">Instansi</td>
    <td style="text-align: center;" width="2%">:</td>
    <td colspan = "14" style="padding-left:0.2em;border-style:solid;">' . $viewPengarah['unit_kerja'] . ', ' . $viewPengarah['kabkota_unit_kerja'] . '</td>
    </tr>');
$mpdf->WriteHTML('</table>');
...
$mpdf->WriteHTML('<div style="padding-top:50px;">
    ...
    <div><p>' . ucwords(str_replace(["kabupaten ", "kota "], ["kab. ", "kota "], $viewKeg['nama_kab'])) . ', ' . Indonesia2Tgl($viewPengarah['tgl_selesai']) . '</p>
    <p>Yang Menyatakan</p>
    <br>
    <br>
    <br>
    ...
    <br>
    <br>
    <p>' . $viewPengarah['nama'] . '</p>
    <p>NIP. ' . $viewPengarah['nip'] . '</p>
    </td>
    </tr>
    </table>
    </div>');
