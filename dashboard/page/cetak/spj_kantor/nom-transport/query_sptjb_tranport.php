...
where tb_pengarah_keg_kantor.id_keg = '$id_keg' order by tb_pengarah_keg_kantor.created_date desc");
...
where tb_narsum_keg_kantor.id_keg = '$id_keg' order by tb_narsum_keg_kantor.created_date desc");
...
order by tb_panitia_keg_kantor.id_jab_st desc");
