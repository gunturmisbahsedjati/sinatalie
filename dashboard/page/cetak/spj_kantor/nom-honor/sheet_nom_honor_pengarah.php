...
while ($viewPengarah = mysqli_fetch_array($sqlPengarah)) {
    ...
    $excel->setActiveSheetIndex(4)->setCellValue('G' . $numrowHonorPengarah, $potonganHonorPengarah);
    ...
    $allPajakPengarah = $allPajakPengarah + $potonganHonorPengarah;
