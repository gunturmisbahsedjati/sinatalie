...
$excel->setActiveSheetIndex(0)->setCellValue('AA1', "Transport Lokal Jakarta");
...
$excel->getActiveSheet()->getStyle('A1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('B1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('C1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('D1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('D1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('F1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('E1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('F1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('G1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('H1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('I1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('J1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('K1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('L1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('M1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('N1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('O1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('P1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('Q1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('R1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('S1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('T1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('U1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('V1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('W1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('X1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('Y1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('Z1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AA1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AB1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AC1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AD1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AE1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AF1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AG1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AH1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AI1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AJ1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AK1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AL1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AM1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AN1')->applyFromArray($style_col_master);
$excel->getActiveSheet()->getStyle('AO1')->applyFromArray($style_col_master);
...
while ($viewPengarah = mysqli_fetch_array($sqlPengarah)) {
    ...
    if ($viewPengarah['jenis_pengarah'] == 'internal') {
        $viewPengarah['bbm'] = '';
        $viewPengarah['tiket_pesawat'] = '';
        $viewPengarah['tiket'] = '';
        $viewPengarah['tiket_kapal'] = '';
        $viewPengarah['lokal'] = '';
        $viewPengarah['taksi'] = '';
        $viewPengarah['toll'] = '';
        $viewPengarah['dpr1'] = '';
        ...
        $viewPengarah['bbm'] = $viewPengarah['bbm'];
        $viewPengarah['tiket_pesawat'] = $viewPengarah['tiket_pesawat'];
        $viewPengarah['tiket'] = $viewPengarah['tiket'];
        $viewPengarah['tiket_kapal'] = $viewPengarah['tiket_kapal'];
        $viewPengarah['lokal'] = $viewPengarah['lokal'];
        $viewPengarah['taksi'] = $viewPengarah['taksi'];
        $viewPengarah['toll'] = $viewPengarah['toll'];
        $viewPengarah['dpr1'] = $viewPengarah['dpr1'];
        $viewPengarah['dpr2'] = $viewPengarah['dpr2'];
    } else {
        $viewPengarah['bbm'] = '';
        $viewPengarah['tiket_pesawat'] = '';
        $viewPengarah['tiket'] = '';
...
while ($viewNarsum = mysqli_fetch_array($sqlNarsum)) {
    ...
    if ($viewNarsum['jenis_narsum'] == 'internal') {
        $viewNarsum['bbm'] = '';
        $viewNarsum['tiket_pesawat'] = '';
        $viewNarsum['tiket'] = '';
        $viewNarsum['tiket_kapal'] = '';
        $viewNarsum['lokal'] = '';
        $viewNarsum['taksi'] = '';
        $viewNarsum['toll'] = '';
        $viewNarsum['dpr1'] = '';
        ...
        $viewNarsum['bbm'] = $viewNarsum['bbm'];
        $viewNarsum['tiket_pesawat'] = $viewNarsum['tiket_pesawat'];
        $viewNarsum['tiket'] = $viewNarsum['tiket'];
        $viewNarsum['tiket_kapal'] = $viewNarsum['tiket_kapal'];
        $viewNarsum['lokal'] = $viewNarsum['lokal'];
        $viewNarsum['taksi'] = $viewNarsum['taksi'];
        $viewNarsum['toll'] = $viewNarsum['toll'];
        $viewNarsum['dpr1'] = $viewNarsum['dpr1'];
        $viewNarsum['dpr2'] = $viewNarsum['dpr2'];
    } else {
        $viewNarsum['bbm'] = '';
        $viewNarsum['tiket_pesawat'] = '';
        $viewNarsum['tiket'] = '';
    ...
    if ($viewNarsum['jenis_narsum'] == 'internal') {
        ...
        if ($viewNarsum['status_internal_kemdikbud'] == 1) {
            ...
            $totalTransportNarsum = $totalTransportNarsum;
        } else {
            $uangHarianNarsum = '';
...
while ($viewPanitia = mysqli_fetch_array($sqlPanitia)) {
    ...
    if ($viewPanitia['jenis_panitia'] == 'internal') {
        $viewPanitia['bbm'] = '';
        $viewPanitia['tiket_pesawat'] = '';
        $viewPanitia['tiket'] = '';
        $viewPanitia['tiket_kapal'] = '';
        $viewPanitia['lokal'] = '';
        $viewPanitia['taksi'] = '';
        $viewPanitia['toll'] = '';
        $viewPanitia['dpr1'] = '';
        $viewPanitia['dpr2'] = '';
    } elseif ($viewPanitia['jenis_panitia'] == 'eksternal') {
        $viewPanitia['bbm'] = $viewPanitia['bbm'];
        $viewPanitia['tiket_pesawat'] = $viewPanitia['tiket_pesawat'];
        $viewPanitia['tiket'] = $viewPanitia['tiket'];
        $viewPanitia['tiket_kapal'] = $viewPanitia['tiket_kapal'];
        $viewPanitia['lokal'] = $viewPanitia['lokal'];
        $viewPanitia['taksi'] = $viewPanitia['taksi'];
        $viewPanitia['toll'] = $viewPanitia['toll'];
        $viewPanitia['dpr1'] = $viewPanitia['dpr1'];
        $viewPanitia['dpr2'] = $viewPanitia['dpr2'];
    } else {
        $viewPanitia['bbm'] = '';
        $viewPanitia['tiket_pesawat'] = '';
        $viewPanitia['tiket'] = '';
    ...
    if ($viewPanitia['jenis_panitia'] == 'internal') {
        ...
        $uangHarianPanitia = $uangHarianPanitia;
    }
...
while ($viewPeserta = mysqli_fetch_array($sqlPeserta)) {
    ...
    if ($viewPeserta['jenis_peserta'] == 'internal') {
        $viewPeserta['bbm'] = '';
        $viewPeserta['tiket_pesawat'] = '';
        $viewPeserta['tiket'] = '';
        $viewPeserta['tiket_kapal'] = '';
        $viewPeserta['lokal'] = '';
        $viewPeserta['taksi'] = '';
        $viewPeserta['toll'] = '';
        $viewPeserta['dpr1'] = '';
        $viewPeserta['dpr2'] = '';
        $uangPerHarianPeserta = '';
        $warnaPeserta = $style_row_peserta_internal;
    } elseif ($viewPeserta['jenis_peserta'] == 'eksternal') {
        $viewPeserta['bbm'] = $viewPeserta['bbm'];
        $viewPeserta['tiket_pesawat'] = $viewPeserta['tiket_pesawat'];
        $viewPeserta['tiket'] = $viewPeserta['tiket'];
        $viewPeserta['tiket_kapal'] = $viewPeserta['tiket_kapal'];
        $viewPeserta['lokal'] =  $viewPeserta['lokal'];
        $viewPeserta['taksi'] = $viewPeserta['taksi'];
        $viewPeserta['toll'] = $viewPeserta['toll'];
        $viewPeserta['dpr1'] = $viewPeserta['dpr1'];
        $viewPeserta['dpr2'] = $viewPeserta['dpr2'];
        $uangPerHarianPeserta = $viewPerjadin['uh_peserta'];
        $warnaPeserta = $style_row;
    } else {
        $viewPeserta['bbm'] = '';
        $viewPeserta['tiket_pesawat'] = '';
        $viewPeserta['tiket'] = '';
    ...
    if ($viewPeserta['status_kabkota_unit_kerja'] == 'Daratan') {
        ...
        $uangHarianPeserta = $uangPerHarianPeserta * $jmlHariPeserta;
        $tiketKapal = 0;
        ...
        $uangHarianPeserta = $uangPerHarianPeserta * $jmlHariPeserta;
        $uangHarianPesertaHmin1 = $uangPerHarianPeserta;
        $uangHarianPesertaHplus1 = $uangPerHarianPeserta;
    ...
    $excel->setActiveSheetIndex(0)->setCellValue('I' . $numrow, Indonesia2Tgl($viewPerjadin['tgl_mulai']));
    $excel->setActiveSheetIndex(0)->setCellValue('J' . $numrow, Indonesia2Tgl($viewPerjadin['tgl_selesai']));
    $excel->setActiveSheetIndex(0)->setCellValue('K' . $numrow, $jmlHariPeserta . ' Hari');
    ...
    $excel->setActiveSheetIndex(0)->setCellValue('P' . $numrow, $pajakPeserta['gol']);
    ...
    $excel->getActiveSheet()->getStyle('A' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('B' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('C' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('D' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('E' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('F' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('G' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('H' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('I' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('J' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('K' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('L' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('M' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('N' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('O' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('P' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('Q' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('R' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('S' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('T' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('U' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('V' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('W' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('X' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('Y' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('Z' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AA' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AB' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AC' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AD' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AE' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AF' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AG' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AH' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AI' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AJ' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AK' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AL' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AM' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AN' . $numrow)->applyFromArray($warnaPeserta);
    $excel->getActiveSheet()->getStyle('AO' . $numrow)->applyFromArray($warnaPeserta);
