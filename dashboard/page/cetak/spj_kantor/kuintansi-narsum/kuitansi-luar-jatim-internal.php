...
$mpdf->WriteHTML('<tr>
                    ...
                    <td width="25%" style="text-align:center;vertical-align:middle;font-weight:bold;border-style:solid;border-width: 1px 0px 1px 0px;background-color:#cfcfcf">' . format_angka($jmlPerjadinNarsum) . ',-</td>
                    <td></td>
                </tr>');
$mpdf->WriteHTML('<tr>
                    <td height="20px"></td>
...
$mpdf->WriteHTML('<tr>
                    ...
                    <td width="3%" style="vertical-align:top;text-align:center;">:</td>
                    <td colspan="3" style="vertical-align:top;text-align: justify;text-justify: inter-word;">( ' . ucwords(terbilang($jmlPerjadinNarsum)) . ' )</td>
                </tr>');
$mpdf->WriteHTML('<tr>
                    <td height="20px"></td>
                    <td></td>
...
$mpdf->WriteHTML('<tr>
                    ...
                    <td colspan="3" style="vertical-align:top;text-align: justify;text-justify: inter-word;">
                        <span style="font-weight:bold;">Biaya Perjalanan Dinas Nara Sumber</span><br>
                        <span style="font-weight:bold;">' . $viewKeg['nama_keg_kuitansi'] . ',</span><br>
                        <span>di ' . $viewKeg['tempat_keg'] . '</span><br>
                        <span>Tgl. ' . Indonesia2Tgl($viewNarsum['tgl_mulai']) . ' s.d ' . Indonesia2Tgl($viewNarsum['tgl_selesai']) . '</span><br>
                        <span style="font-weight:bold;">' . $viewNarsum['kabkota_unit_kerja'] . ' - ' . str_replace('Kabupaten', 'Kab.', ucwords($viewKeg['nama_kab'])) . ' PP</span>
                    </td>
                </tr>');
$mpdf->WriteHTML('</table><br>');
...
$mpdf->WriteHTML('<tr>
                ...
                <td width="2%">:</td>
                <td width="2%">Rp.</td>
                <td style="text-align:right" width="20%">' . format_angka($transportNarsum) . ',-</td>
                <td></td>
                </tr>
                <tr>
                <td width="23%"></td>
                <td width="7%"></td>
                <td width="30%">Tiket Pesawat PP.</td>
                <td width="3%"></td>
                <td width="2%">:</td>
                <td width="2%">Rp.</td>
                <td style="text-align:right" width="20%">' . format_angka($tiketPesawat) . ',-</td>
                <td></td>
                </tr>
                <tr>
                <td width="23%"></td>
                <td width="7%"></td>
                <td width="30%">Uang Harian (' . $jmlHariNarsum . ' Hari)</td>
                <td width="3%"></td>
                <td width="2%">:</td>
                <td width="2%">Rp.</td>
                <td style="text-align:right" width="20%">' . format_angka($uangHarianNarsum) . ',-</td>
                <td></td>
                </tr>
                <tr>
                <td width="23%"></td>
                <td width="7%"></td>
                <td width="30%">Penginapan (' . (($jmlHariNarsum - 1) <= 0 ? 1 : ($jmlHariNarsum - 1)) . ' Hari)</td>
                <td width="3%"></td>
                <td width="2%">:</td>
                <td width="2%">Rp.</td>
                <td style="text-align:right" width="20%">' . format_angka($hotel) . ',-</td>
                <td></td>
                </tr>
                <tr>
                <td width="23%"></td>
                ...
                <td style="text-align:right;font-weight:bold;border-style:solid;border-width:1px 0 0 0;" width="20%">' . format_angka($jmlPerjadinNarsum) . ',-</td>
                <td></td>
                </tr>');
$mpdf->WriteHTML('</table>');

$mpdf->WriteHTML('<div style="padding-top:20px;padding-bottom:20px;">
                <table border="0" style="margin: 0 auto;border-collapse: collapse;margin-top:3em;margin-bottom:1em" width="800px">
                    <tr>
                        <td></td>
                        <td width="45%" style="padding-left:2em">
                            <div>
                                <p>' . ucwords(str_replace(["kabupaten ", "kota "], ["kab. ", "kota "], $viewKeg['nama_kab'])) . ', ' . Indonesia2Tgl($viewNarsum['tgl_selesai']) . '</p>
                                <p>Yang Menyatakan</p>
                                <br>
                                <br>
                                <br>
                                ...
                                <br>
                                <br>
                                <p style="">' . $viewNarsum['nama'] . '</p>
                                <p style="">NIP. ' . $viewNarsum['nip'] . '</p>
                        </td>
                    </tr>
                </table>
            </div>');
...
$mpdf->WriteHTML('
                <tr>
                    <td colspan="4" style="border-style:solid;border-width:1px 0 0 0;padding-top:1em">Setuju Dibayar :</td>
                </tr>
                <tr>
                    <td></td>
