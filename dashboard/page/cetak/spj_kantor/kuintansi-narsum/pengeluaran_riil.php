...
$mpdf->WriteHTML('<tr>
        <td style="padding-top:2em;text-align: center;border-style:solid;border-width: 1px 1px 0px 1px" width="5%" height="">1.</td>
        <td style="padding-top:2em;padding-left:0.8em;border-style:solid;border-width: 1px 1px 0px 1px">Transport ' . str_replace('Kabupaten', 'Kab.', ucwords($viewKeg['nama_kab'])) . ' - ' . str_replace('Kabupaten', 'Kab.', ucwords($viewKeg['nama_kab'])) . ' PP</td>
        <td style="padding-top:2em;text-align: right;padding-right:0.8em;border-style:solid;border-width: 1px 1px 0px 1px">Rp. ' . format_angka($viewNarsum['lokal']) . ',-</td>
    </tr>');
$mpdf->WriteHTML('<tr>
        <td style="padding-bottom:2em;text-align: center;border-style:solid;border-width: 0px 1px 1px 1px" width="5%" height="">2.</td>
        <td style="padding-bottom:2em;padding-left:0.8em;border-style:solid;border-width: 0px 1px 1px 1px">Transport ' . $viewNarsum['kabkota_unit_kerja'] . ' - ' . $viewNarsum['kabkota_unit_kerja'] . ' PP</td>
        <td style="padding-bottom:2em;text-align: right;padding-right:0.8em;border-style:solid;border-width: 0px 1px 1px 1px">Rp. ' . format_angka($viewNarsum['dpr1']) . ',-</td>
    </tr>');
$mpdf->WriteHTML('<tr>
        <td style="text-align: center;" width="5%" height="25px"></td>
        <td style="text-align: center;font-weight:bold">Jumlah</td>
        <td style="text-align: right;padding-right:0.8em;font-weight:bold">Rp. ' . format_angka($viewNarsum['lokal'] + $viewNarsum['dpr1']) . ',-</td>
    </tr>');
