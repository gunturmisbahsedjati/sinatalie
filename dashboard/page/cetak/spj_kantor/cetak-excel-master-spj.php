...
if (empty($_SESSION['username']) && !isset($_SESSION['status_login'])) {
	...
	if (isset($_GET['_token'])) {
		...
		if (mysqli_num_rows($sqlKegiatan) > 0) {
			...
			$style_row_peserta_internal = array(
				'fill' => array(
					'type' => PHPExcel_Style_Fill::FILL_SOLID,
			...
			$styleSudah = array(
				'font'  => array(
					'bold'  => true,
					'color' => array('rgb' => '00ff29')
				)
			);

			$styleTidakIkut = array(
				'font'  => array(
					'bold'  => true,
			...
			include_once 'master-spj/sheet_master_spj.php';
			include_once 'master-spj/sheet_master_spj_pecahan_uang.php';
			include_once 'nom-transport/sheet_nom_transport_pengarah.php';
			include_once 'nom-transport/sheet_nom_transport_narsum.php';
			include_once 'nom-transport/sheet_nom_transport_panitia.php';
			include_once 'nom-transport/sheet_nom_transport_peserta.php';
			include_once 'nom-transport/sheet_sptjb_transport.php';
			...
			// header('Content-Disposition: attachment; filename="Master SPJ ' . $viewPerjadin['nama_keg_kuitansi'] . '.xlsx"');
