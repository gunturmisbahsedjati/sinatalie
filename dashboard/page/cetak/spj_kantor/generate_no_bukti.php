...
$jmlPengarah = mysqli_num_rows(mysqli_query($myConnection, "select * from tb_pengarah_keg_kantor where id_keg = '$id_keg' and soft_delete =0"));
$jmlNarsum = mysqli_num_rows(mysqli_query($myConnection, "select * from tb_narsum_keg_kantor where id_keg = '$id_keg' and soft_delete =0"));
$jmlPanitia = mysqli_num_rows(mysqli_query($myConnection, "select * from tb_panitia_keg_kantor where id_keg = '$id_keg' and soft_delete =0"));
$jmlPeserta = mysqli_num_rows(mysqli_query($myConnection, "select * from tb_peserta_keg_kantor where id_keg = '$id_keg' and soft_delete =0"));
