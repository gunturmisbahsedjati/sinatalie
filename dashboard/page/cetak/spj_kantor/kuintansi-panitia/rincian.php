...
$mpdf->WriteHTML('<tr>
                ...
                <td style="border-left:0px;text-align:right;padding-right:0.8em;border-style:solid;border-width: 0px 0px 0px 0px">' . format_angka($transportPanitia) . ',-</td>
                <td style="border-style:solid;border-width: 0px 1px 0px 1px"></td>
                </tr>
                <tr>
                <td style="text-align:center;border-style:solid;border-width: 0px 1px 0px 1px" height="40px">2.</td>
                <td style="padding-left:0.8em;border-style:solid;border-width: 0px 1px 0px 0px">Uang Harian (' . $jmlHariPanitia . ' Hari)</td>
                <td style="border-style:solid;border-width: 0px 0px 0px 0px;padding-left:0.8em;">Rp</td>
                <td style="border-left:0px;text-align:right;padding-right:0.8em;border-style:solid;border-width: 0px 0px 0px 0px">' . format_angka($uangHarianPanitia) . ',-</td>
                <td style="border-style:solid;border-width: 0px 1px 0px 1px"></td>
                </tr>
                <tr>
                <td  height="40px"></td>
                ...
                <td style="border-left:0px;text-align:right;padding-right:0.8em;font-weight:bold">' . format_angka($jmlPerjadinPanitia) . ',-</td>
                <td></td>
                </tr>');
$mpdf->WriteHTML("</table><br>");
...
$mpdf->WriteHTML('<tr>
        <td>Rp. ' . format_angka($jmlPerjadinPanitia) . '.-</td>
        <td>Rp. ' . format_angka($jmlPerjadinPanitia) . '.-</td>
    </tr>');
$mpdf->WriteHTML('<tr>
...
$mpdf->WriteHTML('<tr>
        ...
        <td>' . $viewPanitia['nama'] . '</td>
    </tr>');
$mpdf->WriteHTML('<tr>
        <td style="border-style:solid;border-bottom:1px;">NIP. ' . $viewBendahara['nip'] . '</td>
        <td style="border-style:solid;border-bottom:1px;">NIP. ' . $viewPanitia['nip'] . '</td>
    </tr>');
$mpdf->WriteHTML("</table>");
...
$mpdf->WriteHTML('<tr>
        ...
        <td width="2%">:</td>
        <td width="2%">Rp. </td>
        <td width="15%" style="text-align:right;">' . format_angka($jmlPerjadinPanitia) . ',-</td>
        <td></td>
        <td></td>
    </tr>');
$mpdf->WriteHTML('<tr>
        ...
        <td width="15%" style="text-align:right;border-style:solid;border-bottom:1px">' . format_angka($jmlPerjadinPanitia) . ',-</td>
        <td></td>
        <td></td>
    </tr>');
$mpdf->WriteHTML('<tr>
