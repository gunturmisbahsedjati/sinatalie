...
$mpdf->WriteHTML('<tr>
                    ...
                    <td width="25%" style="text-align:center;vertical-align:middle;font-weight:bold;border-style:solid;border-width: 1px 0px 1px 0px;background-color:#cfcfcf">' . format_angka($transportPengarah) . ',-</td>
                    <td></td>
                </tr>');
$mpdf->WriteHTML('<tr>
                    <td height="20px"></td>
...
$mpdf->WriteHTML('<tr>
                    ...
                    <td width="3%" style="vertical-align:top;text-align:center;">:</td>
                    <td colspan="3" style="vertical-align:top;text-align: justify;text-justify: inter-word;">( ' . ucwords(terbilang($transportPengarah)) . ' )</td>
                </tr>');
$mpdf->WriteHTML('<tr>
                    <td height="20px"></td>
                    <td></td>
...
$mpdf->WriteHTML('<tr>
                    ...
                    <td colspan="3" style="vertical-align:top;text-align: justify;text-justify: inter-word;">
                        <span style="font-weight:bold;">Biaya Perjalanan Dinas Pengarah</span><br>
                        <span style="font-weight:bold;">' . $viewKeg['nama_keg_kuitansi'] . ',</span><br>
                        <span>di ' . $viewKeg['tempat_keg'] . '</span><br>
                        <span>Tgl. ' . Indonesia2Tgl($viewPengarah['tgl_mulai']) . ' s.d ' . Indonesia2Tgl($viewPengarah['tgl_selesai']) . '</span><br>
                        <span style="font-weight:bold;">' . $viewPengarah['kabkota_unit_kerja'] . ' - ' . str_replace('Kabupaten', 'Kab.', ucwords($viewKeg['nama_kab'])) . ' PP</span>
                    </td>
                </tr>');
$mpdf->WriteHTML('</table><br>');
...
$mpdf->WriteHTML('<tr>
                ...
                <td width="2%">:</td>
                <td width="2%">Rp.</td>
                <td style="text-align:right" width="20%">' . format_angka($transportPengarah) . ',-</td>
                <td></td>
                </tr>
                <tr>
                <td height="40px"></td>
                ...
                <td style="text-align:right;font-weight:bold;border-style:solid;border-width:1px 0 0 0;" width="20%">' . format_angka($transportPengarah) . ',-</td>
                <td></td>
                </tr>');
$mpdf->WriteHTML('</table>');
