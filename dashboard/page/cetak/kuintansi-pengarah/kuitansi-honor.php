...
$mpdf->WriteHTML('<tr>
                    ...
                    <td width="25%" style="text-align:center;vertical-align:middle;font-weight:bold;border-style:solid;border-width: 1px 0px 1px 0px;background-color:#cfcfcf">' . format_angka($uangHonorPengarah) . ',-</td>
                    <td></td>
                </tr>');
$mpdf->WriteHTML('<tr>
                    <td height="20px"></td>
...
$mpdf->WriteHTML('<tr>
                    ...
                    <td width="3%" style="vertical-align:top;text-align:center;">:</td>
                    <td colspan="3" style="vertical-align:top;text-align: justify;text-justify: inter-word;">( ' . ucwords(terbilang($uangHonorPengarah)) . ' )</td>
                </tr>');
$mpdf->WriteHTML('<tr>
                    <td height="20px"></td>
                    <td></td>
...
$mpdf->WriteHTML('<tr>
                    ...
                    <td colspan="3" style="vertical-align:top;text-align: justify;text-justify: inter-word;">
                        <span style="font-weight:bold;">Honorariun Pengarah</span><br>
                        <span style="font-weight:bold;">' . $viewKeg['nama_keg_kuitansi'] . ',</span><br>
                        <span>di ' . $viewKeg['tempat_keg'] . '</span><br>
                        <span>Tgl. ' . Indonesia2Tgl($viewPengarah['tgl_mulai']) . ' s.d ' . Indonesia2Tgl($viewPengarah['tgl_selesai']) . '</span>
                    </td>
                </tr>');
$mpdf->WriteHTML('</table><br>');
...
$mpdf->WriteHTML('<tr>
                <td width="23%"></td>
                <td width="7%"></td>
                <td width="30%">Honorarium ' . $jmlJamPengarah . ' Jp x Rp. ' . format_angka($viewKeg['honor_pengarah_e']) . ',-</td>
                <td width="3%"></td>
                <td width="2%">:</td>
                <td width="2%">Rp.</td>
                <td style="text-align:right" width="20%">' . format_angka($uangHonorPengarah) . ',-</td>
                <td></td>
                </tr>
               <tr>
                <td width="23%"></td>
                ...
                <td width="2%">:</td>
                <td width="2%">Rp.</td>
                <td style="text-align:right" width="20%">' . format_angka($potonganHonor) . ',-</td>
                ...
                <td style="text-align:right;font-weight:bold;border-style:solid;border-width:1px 0 0 0;" width="20%">' . format_angka($uangHonorPengarahPotongan) . ',-</td>
                <td></td>
                </tr>');
$mpdf->WriteHTML('</table>');
                ...
                <table border="0" style="margin: 0 auto;border-collapse: collapse;margin-top:3em;margin-bottom:1em" width="800px">
                    <tr>
                        ...
                        <td width="45%" style="padding-left:2em">
                            <div>
                                <p>' . ucwords(str_replace(["kabupaten ", "kota "], ["kab. ", "kota "], $viewKeg['nama_kab'])) . ', ' . Indonesia2Tgl($viewPengarah['tgl_selesai']) . '</p>
                                <p>Yang Menyatakan</p>
                                <br>
                                <br>
                                <br>
                                ...
                                <br>
                                <br>
                                <p style="">' . $viewPengarah['nama'] . '</p>
                                <p style="">NIP. ' . $viewPengarah['nip'] . '</p>
                        </td>
                    </tr>
                </table>
            </div></div>');
